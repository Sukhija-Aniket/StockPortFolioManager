...
class ExecutionRecordService:
    ...
    def load_execution_record(self, spreadsheet_id: str) -> Optional[ExecutionRecord]:
        """
        ...
        try:
            ...
            record = db.query(ExecutionRecord).filter_by(
                spreadsheet_id=spreadsheet_id
    ...
    def data_has_changed(self, spreadsheet_id: str, current_data) -> bool:
        ...
        record = self.load_execution_record(spreadsheet_id)
        ...
        if last_hash != current_hash:
            ...
            logger.info(f"Last execution had failed for {spreadsheet_id}, will process")
            return True
